  ...
  group("SubPageNavigationWidget", () {
    testWidgets('Current sub-page indicator, shows the current sub-page',
      ...
      MaterialApp app = MaterialApp(
          home:
              Scaffold(body: SubPageNavigationWidget(wide: false, page: page)));
    ...
    testWidgets('Only one sub-page, delete button is disabled',
      ...
      _assertDeleteSubPageIsDisabled(tester);
    });
  });
}

void _assertDeleteSubPageIsDisabled(WidgetTester tester) {
  expect(
      tester
          .widget<IconButton>(
