...
class NewTitleDialog extends StatefulWidget {
  ...
  const NewTitleDialog({Key? key, required this.titles, required this.fetchData,}) : super(key: key);
                    ...
                    AlertDialog(
                      ...
                      actions: [
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                            List<String> titleList = widget.titles.map((record) => record['title'] as String).toList();
