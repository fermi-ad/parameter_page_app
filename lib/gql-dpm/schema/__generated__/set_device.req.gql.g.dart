...
part of 'set_device.req.gql.dart';
...
class _$GSetDeviceReqSerializer implements StructuredSerializer<GSetDeviceReq> {
  @override
  final Iterable<Type> types = const [GSetDeviceReq, _$GSetDeviceReq];
  @override
...
class _$GSetDeviceReq extends GSetDeviceReq {
  @override
  final _i3.GSetDeviceVars vars;
  @override
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'GSetDeviceReq')
          ..add('vars', vars)
...
class GSetDeviceReqBuilder
    implements Builder<GSetDeviceReq, GSetDeviceReqBuilder> {
  _$GSetDeviceReq? _$v;
  ...
  GSetDeviceReqBuilder() {
    GSetDeviceReq._initializeBuilder(this);
  }

  GSetDeviceReqBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void update(void Function(GSetDeviceReqBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  GSetDeviceReq build() => _build();
